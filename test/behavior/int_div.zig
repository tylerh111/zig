...
fn test_division() !void {
    ...
    try expect(div_exact(i64, -55, 11) == -5);
    try expect(div_exact(i16, -55, 11) == -5);

    try expect(div_floor(i8, 5, 3) == 1);
    try expect(div_floor(i16, -5, 3) == -2);
    try expect(div_floor(i64, -0x80000000, -2) == 0x40000000);
    try expect(div_floor(i32, 0, -0x80000000) == 0);
    try expect(div_floor(i64, -0x40000001, 0x40000000) == -2);
