...
pub const Token = struct {
    ...
    pub const Id = enum(u8) {
        ...
        pub fn is_macro_identifier(id: Id) bool {
            switch (id) {
                .keyword_include,
                .keyword_include_next,
                .keyword_embed,
        ...
        pub fn simplify_macro_keyword_extra(id: *Id, defined_to_identifier: bool) void {
            switch (id.*) {
                .keyword_include,
                .keyword_include_next,
                .keyword_embed,
        ...
        pub fn valid_preprocessor_expr_start(id: Id) bool {
            return switch (id) {
                .eof,
                .r_paren,
                .string_literal,
        ...
        pub fn allows_digraphs(id: Id, langopts: LangOpts) bool {
            return switch (id) {
                .l_bracket,
                .r_bracket,
                .l_brace,
        ...
        pub fn can_open_gccasm_stmt(id: Id) bool {
            return switch (id) {
        ...
        pub fn is_string_literal(id: Id) bool {
            return switch (id) {
    ...
    /// to keywords.
    pub fn get_token_id(langopts: LangOpts, str: []const u8) Token.Id {
...
pub fn next_no_ws(self: *Tokenizer) Token {
    var tok = self.next();
    while (tok.id == .whitespace or tok.id == .comment) tok = self.next();
    return tok;
}

pub fn next_no_wscomments(self: *Tokenizer) Token {
    var tok = self.next();
...
fn expect_tokens_extra(contents: []const u8, expected_tokens: []const Token.Id, standard: ?LangOpts.Standard) !void {
