...
fn __cmpsf2(a: f32, b: f32) callconv(.C) i32 {
    return @int_from_enum(comparef.cmpf2(f32, comparef.LE, a, b));
}
...
fn __aeabi_fcmpeq(a: f32, b: f32) callconv(.AAPCS) i32 {
    return @int_from_bool(comparef.cmpf2(f32, comparef.LE, a, b) == .Equal);
}

fn __aeabi_fcmplt(a: f32, b: f32) callconv(.AAPCS) i32 {
    return @int_from_bool(comparef.cmpf2(f32, comparef.LE, a, b) == .Less);
}

fn __aeabi_fcmple(a: f32, b: f32) callconv(.AAPCS) i32 {
    return @int_from_bool(comparef.cmpf2(f32, comparef.LE, a, b) != .Greater);
}
