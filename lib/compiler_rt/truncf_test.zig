...
fn test__truncsfhf2(a: u32, expected: u16) !void {
    const actual: u16 = @bit_cast(__truncsfhf2(@bit_cast(a)));
...
fn test__truncdfhf2(a: f64, expected: u16) void {
    const rep: u16 = @bit_cast(__truncdfhf2(a));
...
fn test__truncdfhf2_raw(a: u64, expected: u16) void {
    const actual: u16 = @bit_cast(__truncdfhf2(@bit_cast(a)));
...
test "trunctfsf2" {
    // qnan
    test__trunctfsf2(@bit_cast(@as(u128, 0x7fff800000000000 << 64)), 0x7fc00000);
    // nan
    test__trunctfsf2(@bit_cast(@as(u128, (0x7fff000000000000 | (0x810000000000 & 0xffffffffffff)) << 64)), 0x7fc08000);
    // inf
    test__trunctfsf2(@bit_cast(@as(u128, 0x7fff000000000000 << 64)), 0x7f800000);
    // zero
...
test "trunctfdf2" {
    // qnan
    test__trunctfdf2(@bit_cast(@as(u128, 0x7fff800000000000 << 64)), 0x7ff8000000000000);
    // nan
    test__trunctfdf2(@bit_cast(@as(u128, (0x7fff000000000000 | (0x810000000000 & 0xffffffffffff)) << 64)), 0x7ff8100000000000);
    // inf
    test__trunctfdf2(@bit_cast(@as(u128, 0x7fff000000000000 << 64)), 0x7ff0000000000000);
    // zero
...
test "truncdfsf2" {
    // nan & qnan
    test__truncdfsf2(@bit_cast(@as(u64, 0x7ff8000000000000)), 0x7fc00000);
    test__truncdfsf2(@bit_cast(@as(u64, 0x7ff0000000000001)), 0x7fc00000);
    // inf
    test__truncdfsf2(@bit_cast(@as(u64, 0x7ff0000000000000)), 0x7f800000);
    test__truncdfsf2(@bit_cast(@as(u64, 0xfff0000000000000)), 0xff800000);
...
test "trunctfhf2" {
    // qNaN
    test__trunctfhf2(@bit_cast(@as(u128, 0x7fff8000000000000000000000000000)), 0x7e00);
    // NaN
    test__trunctfhf2(@bit_cast(@as(u128, 0x7fff0000000000000000000000000001)), 0x7e00);
    // inf
    test__trunctfhf2(@bit_cast(@as(u128, 0x7fff0000000000000000000000000000)), 0x7c00);
    test__trunctfhf2(-@as(f128, @bit_cast(@as(u128, 0x7fff0000000000000000000000000000))), 0xfc00);
    // zero
