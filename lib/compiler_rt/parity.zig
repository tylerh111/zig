...
pub fn __paritysi2(a: i32) callconv(.C) i32 {
    return parity_xi2(i32, a);
}

pub fn __paritydi2(a: i64) callconv(.C) i32 {
    return parity_xi2(i64, a);
}

pub fn __parityti2(a: i128) callconv(.C) i32 {
    return parity_xi2(i128, a);
}

inline fn parity_xi2(comptime T: type, a: T) i32 {
    ...
    x &= 0xf;
    return (@as(u16, 0x6996) >> @int_cast(x)) & 1; // optimization for >>2 and >>1
}
