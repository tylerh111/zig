...
const PtRegs = @compile_error("TODO missing os bits: PtRegs");
const TcpHdr = @compile_error("TODO missing os bits: TcpHdr");
const SkFullSock = @compile_error("TODO missing os bits: SkFullSock");
