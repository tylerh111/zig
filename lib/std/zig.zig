...
pub const Color = enum {
    ...
    pub fn render_options(color: Color) std.zig.ErrorBundle.RenderOptions {
...
pub fn find_line_column(source: []const u8, byte_offset: usize) Loc {
    var line: usize = 0;
    var column: usize = 0;
...
pub fn line_delta(source: []const u8, start: usize, end: usize) isize {
    var line: isize = 0;
    if (end >= start) {
...
pub fn bin_name_alloc(allocator: Allocator, options: BinNameOptions) error{OutOfMemory}![]u8 {
...
pub const BuildId = union(enum) {
    ...
    pub const HexString = struct {
        ...
        pub fn to_slice(hs: *const HexString) []const u8 {
...
pub const LazySrcLoc = union(enum) {
    ...
    fn node_offset_release(node_offset: i32) LazySrcLoc {
...
pub fn print_ast_errors_to_stderr(gpa: Allocator, tree: Ast, path: []const u8, color: Color) !void {
...
pub fn parse_target_query_or_report_fatal_error(
    allocator: Allocator,
