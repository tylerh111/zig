...
pub fn auto_array_hash_map(comptime K: type, comptime V: type) type {
...
pub fn array_hash_map_unmanaged(
    comptime K: type,
    comptime V: type,
    /// A namespace that provides these two functions:
    /// * `pub fn hash(self, K) u32`
