...
pub fn mul(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    mulx_u64(&x20, &x21, x11, 0xffffffff00000001);
    var x22: u64 = undefined;
    var x23: u64 = undefined;
    mulx_u64(&x22, &x23, x11, 0xffffffff);
    var x24: u64 = undefined;
    var x25: u64 = undefined;
    mulx_u64(&x24, &x25, x11, 0xffffffffffffffff);
    ...
    addcarryx_u64(&x62, &x63, x61, @as(u64, x38), x53);
    var x64: u64 = undefined;
    var x65: u64 = undefined;
    mulx_u64(&x64, &x65, x54, 0xffffffff00000001);
    var x66: u64 = undefined;
    var x67: u64 = undefined;
    mulx_u64(&x66, &x67, x54, 0xffffffff);
    var x68: u64 = undefined;
    var x69: u64 = undefined;
    mulx_u64(&x68, &x69, x54, 0xffffffffffffffff);
    ...
    mulx_u64(&x109, &x110, x99, 0xffffffff00000001);
    var x111: u64 = undefined;
    var x112: u64 = undefined;
    mulx_u64(&x111, &x112, x99, 0xffffffff);
    var x113: u64 = undefined;
    var x114: u64 = undefined;
    mulx_u64(&x113, &x114, x99, 0xffffffffffffffff);
    ...
    mulx_u64(&x154, &x155, x144, 0xffffffff00000001);
    var x156: u64 = undefined;
    var x157: u64 = undefined;
    mulx_u64(&x156, &x157, x144, 0xffffffff);
    var x158: u64 = undefined;
    var x159: u64 = undefined;
    mulx_u64(&x158, &x159, x144, 0xffffffffffffffff);
    ...
    subborrowx_u64(&x174, &x175, 0x0, x165, 0xffffffffffffffff);
    var x176: u64 = undefined;
    var x177: u1 = undefined;
    subborrowx_u64(&x176, &x177, x175, x167, 0xffffffff);
    var x178: u64 = undefined;
    var x179: u1 = undefined;
    subborrowx_u64(&x178, &x179, x177, x169, @as(u64, 0x0));
    var x180: u64 = undefined;
    var x181: u1 = undefined;
    subborrowx_u64(&x180, &x181, x179, x171, 0xffffffff00000001);
    var x182: u64 = undefined;
    var x183: u1 = undefined;
    subborrowx_u64(&x182, &x183, x181, x173, @as(u64, 0x0));
...
pub fn add(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    subborrowx_u64(&x9, &x10, 0x0, x1, 0xffffffffffffffff);
    var x11: u64 = undefined;
    var x12: u1 = undefined;
    subborrowx_u64(&x11, &x12, x10, x3, 0xffffffff);
    var x13: u64 = undefined;
    var x14: u1 = undefined;
    subborrowx_u64(&x13, &x14, x12, x5, @as(u64, 0x0));
    var x15: u64 = undefined;
    var x16: u1 = undefined;
    subborrowx_u64(&x15, &x16, x14, x7, 0xffffffff00000001);
    var x17: u64 = undefined;
    var x18: u1 = undefined;
...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    addcarryx_u64(&x10, &x11, 0x0, x1, x9);
    var x12: u64 = undefined;
    var x13: u1 = undefined;
    addcarryx_u64(&x12, &x13, x11, x3, (x9 & 0xffffffff));
    var x14: u64 = undefined;
    var x15: u1 = undefined;
    addcarryx_u64(&x14, &x15, x13, x5, @as(u64, 0x0));
    var x16: u64 = undefined;
    var x17: u1 = undefined;
    addcarryx_u64(&x16, &x17, x15, x7, (x9 & 0xffffffff00000001));
    out1[0] = x10;
    out1[1] = x12;
    out1[2] = x14;
    out1[3] = x16;
...
pub fn from_montgomery(out1: *NonMontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement) void {
    ...
    var x12: u64 = undefined;
    var x13: u1 = undefined;
    addcarryx_u64(&x12, &x13, x11, @as(u64, 0x0), x8);
    var x14: u64 = undefined;
    var x15: u1 = undefined;
    ...
    var x26: u64 = undefined;
    var x27: u1 = undefined;
    addcarryx_u64(&x26, &x27, x25, (@as(u64, x15) + (@as(u64, x13) + (@as(u64, x9) + x5))), x22);
    var x28: u64 = undefined;
    var x29: u1 = undefined;
    addcarryx_u64(&x28, &x29, x27, x2, (@as(u64, x23) + x19));
    ...
    addcarryx_u64(&x34, &x35, x33, x28, @as(u64, 0x0));
    var x36: u64 = undefined;
    var x37: u1 = undefined;
    addcarryx_u64(&x36, &x37, x35, x30, @as(u64, 0x0));
    ...
    addcarryx_u64(&x50, &x51, x49, x36, (@as(u64, x45) + x41));
    var x52: u64 = undefined;
    var x53: u1 = undefined;
    addcarryx_u64(&x52, &x53, x51, (@as(u64, x37) + (@as(u64, x31) + x17)), x38);
    var x54: u64 = undefined;
    var x55: u1 = undefined;
    addcarryx_u64(&x54, &x55, 0x0, x48, (arg1[3]));
    var x56: u64 = undefined;
    var x57: u1 = undefined;
    addcarryx_u64(&x56, &x57, x55, x50, @as(u64, 0x0));
    var x58: u64 = undefined;
    var x59: u1 = undefined;
    ...
    addcarryx_u64(&x72, &x73, x71, x58, (@as(u64, x67) + x63));
    var x74: u64 = undefined;
    var x75: u1 = undefined;
    addcarryx_u64(&x74, &x75, x73, (@as(u64, x59) + (@as(u64, x53) + x39)), x60);
...
pub fn to_montgomery(out1: *MontgomeryDomainFieldElement, arg1: NonMontgomeryDomainFieldElement) void {
    ...
    var x31: u64 = undefined;
    var x32: u1 = undefined;
    addcarryx_u64(&x31, &x32, x30, x15, (@as(u64, x26) + x22));
    var x33: u64 = undefined;
    var x34: u1 = undefined;
    addcarryx_u64(&x33, &x34, x32, x17, x19);
    var x35: u64 = undefined;
    var x36: u1 = undefined;
    addcarryx_u64(&x35, &x36, x34, (@as(u64, x18) + x6), x20);
    var x37: u64 = undefined;
    var x38: u64 = undefined;
    ...
    addcarryx_u64(&x71, &x72, x70, x55, (@as(u64, x66) + x62));
    var x73: u64 = undefined;
    var x74: u1 = undefined;
    addcarryx_u64(&x73, &x74, x72, x57, x59);
    var x75: u64 = undefined;
    var x76: u1 = undefined;
    addcarryx_u64(&x75, &x76, x74, ((@as(u64, x58) + @as(u64, x36)) + (@as(u64, x50) + x38)), x60);
    var x77: u64 = undefined;
    ...
    addcarryx_u64(&x111, &x112, x110, x95, (@as(u64, x106) + x102));
    var x113: u64 = undefined;
    var x114: u1 = undefined;
    addcarryx_u64(&x113, &x114, x112, x97, x99);
    var x115: u64 = undefined;
    var x116: u1 = undefined;
    addcarryx_u64(&x115, &x116, x114, ((@as(u64, x98) + @as(u64, x76)) + (@as(u64, x90) + x78)), x100);
    ...
    addcarryx_u64(&x151, &x152, x150, x135, (@as(u64, x146) + x142));
    var x153: u64 = undefined;
    var x154: u1 = undefined;
    addcarryx_u64(&x153, &x154, x152, x137, x139);
    var x155: u64 = undefined;
    var x156: u1 = undefined;
    addcarryx_u64(&x155, &x156, x154, ((@as(u64, x138) + @as(u64, x116)) + (@as(u64, x130) + x118)), x140);
    var x157: u64 = undefined;
    ...
    subborrowx_u64(&x161, &x162, x160, x153, @as(u64, 0x0));
    var x163: u64 = undefined;
    var x164: u1 = undefined;
    subborrowx_u64(&x163, &x164, x162, x155, 0xffffffff00000001);
    var x165: u64 = undefined;
    var x166: u1 = undefined;
    subborrowx_u64(&x165, &x166, x164, @as(u64, x156), @as(u64, 0x0));
    var x167: u64 = undefined;
...
pub fn divstep(out1: *u64, out2: *[5]u64, out3: *[5]u64, out4: *[4]u64, out5: *[4]u64, arg1: u64, arg2: [5]u64, arg3: [5]u64, arg4: [4]u64, arg5: [4]u64) void {
    ...
    subborrowx_u64(&x39, &x40, 0x0, x31, 0xffffffffffffffff);
    var x41: u64 = undefined;
    var x42: u1 = undefined;
    subborrowx_u64(&x41, &x42, x40, x33, 0xffffffff);
    var x43: u64 = undefined;
    var x44: u1 = undefined;
    subborrowx_u64(&x43, &x44, x42, x35, @as(u64, 0x0));
    var x45: u64 = undefined;
    var x46: u1 = undefined;
    subborrowx_u64(&x45, &x46, x44, x37, 0xffffffff00000001);
    var x47: u64 = undefined;
    var x48: u1 = undefined;
    ...
    var x62: u64 = undefined;
    var x63: u1 = undefined;
    addcarryx_u64(&x62, &x63, 0x0, x53, x61);
    var x64: u64 = undefined;
    var x65: u1 = undefined;
    addcarryx_u64(&x64, &x65, x63, x55, (x61 & 0xffffffff));
    var x66: u64 = undefined;
    var x67: u1 = undefined;
    addcarryx_u64(&x66, &x67, x65, x57, @as(u64, 0x0));
    var x68: u64 = undefined;
    var x69: u1 = undefined;
    addcarryx_u64(&x68, &x69, x67, x59, (x61 & 0xffffffff00000001));
    var x70: u64 = undefined;
    ...
    subborrowx_u64(&x102, &x103, 0x0, x94, 0xffffffffffffffff);
    var x104: u64 = undefined;
    var x105: u1 = undefined;
    subborrowx_u64(&x104, &x105, x103, x96, 0xffffffff);
    var x106: u64 = undefined;
    var x107: u1 = undefined;
    subborrowx_u64(&x106, &x107, x105, x98, @as(u64, 0x0));
    var x108: u64 = undefined;
    var x109: u1 = undefined;
    subborrowx_u64(&x108, &x109, x107, x100, 0xffffffff00000001);
    var x110: u64 = undefined;
