...
//    .StartAddressOfRawData = @int_from_ptr(&_tls_start),
//    .EndAddressOfRawData = @int_from_ptr(&_tls_end),
//    .AddressOfIndex = @int_from_ptr(&_tls_index),
//    .AddressOfCallBacks = @int_from_ptr(__xl_a),
//    .SizeOfZeroFill = 0,
//    .Characteristics = 0,
//};
// This is the workaround because we can't do @int_from_ptr at comptime like that.
...
export const _tls_used linksection(".rdata$T") = IMAGE_TLS_DIRECTORY{
    ...
    .AddressOfCallBacks = @as(*anyopaque, @ptr_cast(&__xl_a)),
    .SizeOfZeroFill = 0,
    .Characteristics = 0,
};
