...
pub fn biased_fp(comptime T: type) type {
...
pub fn mantissa_type(comptime T: type) type {
    return switch (T) {
        f16, f32, f64 => u64,
        f128 => u128,
        else => unreachable,
