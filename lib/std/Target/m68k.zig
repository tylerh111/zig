...
pub const all_features = blk: {
    ...
    result[@int_from_enum(Feature.isa_68000)] = .{
        .llvm_name = "isa-68000",
        .description = "Is M68000 ISA supported",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.isa_68010)] = .{
        .llvm_name = "isa-68010",
    ...
    result[@int_from_enum(Feature.isa_68020)] = .{
        .llvm_name = "isa-68020",
    ...
    result[@int_from_enum(Feature.isa_68030)] = .{
        .llvm_name = "isa-68030",
    ...
    result[@int_from_enum(Feature.isa_68040)] = .{
        .llvm_name = "isa-68040",
    ...
    result[@int_from_enum(Feature.isa_68060)] = .{
        .llvm_name = "isa-68060",
    ...
    result[@int_from_enum(Feature.isa_68881)] = .{
        .llvm_name = "isa-68881",
        .description = "Is M68881 (FPU) ISA supported",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.isa_68882)] = .{
        .llvm_name = "isa-68882",
