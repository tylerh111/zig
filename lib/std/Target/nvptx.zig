...
pub const all_features = blk: {
    ...
    result[@int_from_enum(Feature.ptx32)] = .{
        .llvm_name = "ptx32",
        .description = "Use PTX version 32",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx40)] = .{
        .llvm_name = "ptx40",
        .description = "Use PTX version 40",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx41)] = .{
        .llvm_name = "ptx41",
        .description = "Use PTX version 41",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx42)] = .{
        .llvm_name = "ptx42",
        .description = "Use PTX version 42",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx43)] = .{
        .llvm_name = "ptx43",
        .description = "Use PTX version 43",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx50)] = .{
        .llvm_name = "ptx50",
        .description = "Use PTX version 50",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx60)] = .{
        .llvm_name = "ptx60",
        .description = "Use PTX version 60",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx61)] = .{
        .llvm_name = "ptx61",
        .description = "Use PTX version 61",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx63)] = .{
        .llvm_name = "ptx63",
        .description = "Use PTX version 63",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx64)] = .{
        .llvm_name = "ptx64",
        .description = "Use PTX version 64",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx65)] = .{
        .llvm_name = "ptx65",
        .description = "Use PTX version 65",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx70)] = .{
        .llvm_name = "ptx70",
        .description = "Use PTX version 70",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx71)] = .{
        .llvm_name = "ptx71",
        .description = "Use PTX version 71",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx72)] = .{
        .llvm_name = "ptx72",
        .description = "Use PTX version 72",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx73)] = .{
        .llvm_name = "ptx73",
        .description = "Use PTX version 73",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx74)] = .{
        .llvm_name = "ptx74",
        .description = "Use PTX version 74",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx75)] = .{
        .llvm_name = "ptx75",
        .description = "Use PTX version 75",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx76)] = .{
        .llvm_name = "ptx76",
        .description = "Use PTX version 76",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx77)] = .{
        .llvm_name = "ptx77",
        .description = "Use PTX version 77",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx78)] = .{
        .llvm_name = "ptx78",
        .description = "Use PTX version 78",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx80)] = .{
        .llvm_name = "ptx80",
        .description = "Use PTX version 80",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx81)] = .{
        .llvm_name = "ptx81",
        .description = "Use PTX version 81",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx82)] = .{
        .llvm_name = "ptx82",
        .description = "Use PTX version 82",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.ptx83)] = .{
        .llvm_name = "ptx83",
        .description = "Use PTX version 83",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_20)] = .{
        .llvm_name = "sm_20",
        .description = "Target SM 20",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_21)] = .{
        .llvm_name = "sm_21",
        .description = "Target SM 21",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_30)] = .{
        .llvm_name = "sm_30",
        .description = "Target SM 30",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_32)] = .{
        .llvm_name = "sm_32",
        .description = "Target SM 32",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_35)] = .{
        .llvm_name = "sm_35",
        .description = "Target SM 35",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_37)] = .{
        .llvm_name = "sm_37",
        .description = "Target SM 37",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_50)] = .{
        .llvm_name = "sm_50",
        .description = "Target SM 50",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_52)] = .{
        .llvm_name = "sm_52",
        .description = "Target SM 52",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_53)] = .{
        .llvm_name = "sm_53",
        .description = "Target SM 53",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_60)] = .{
        .llvm_name = "sm_60",
        .description = "Target SM 60",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_61)] = .{
        .llvm_name = "sm_61",
        .description = "Target SM 61",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_62)] = .{
        .llvm_name = "sm_62",
        .description = "Target SM 62",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_70)] = .{
        .llvm_name = "sm_70",
        .description = "Target SM 70",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_72)] = .{
        .llvm_name = "sm_72",
        .description = "Target SM 72",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_75)] = .{
        .llvm_name = "sm_75",
        .description = "Target SM 75",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_80)] = .{
        .llvm_name = "sm_80",
        .description = "Target SM 80",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_86)] = .{
        .llvm_name = "sm_86",
        .description = "Target SM 86",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_87)] = .{
        .llvm_name = "sm_87",
        .description = "Target SM 87",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_89)] = .{
        .llvm_name = "sm_89",
        .description = "Target SM 89",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_90)] = .{
        .llvm_name = "sm_90",
        .description = "Target SM 90",
        .dependencies = feature_set(&[_]Feature{}),
    };
    result[@int_from_enum(Feature.sm_90a)] = .{
        .llvm_name = "sm_90a",
