...
test "gcd" {
    try expect_equal(gcd(0, 5), 5);
    try expect_equal(gcd(5, 0), 5);
    try expect_equal(gcd(8, 12), 4);
    try expect_equal(gcd(12, 8), 4);
    try expect_equal(gcd(33, 77), 11);
    try expect_equal(gcd(77, 33), 11);
    try expect_equal(gcd(49865, 69811), 9973);
    try expect_equal(gcd(300_000, 2_300_000), 100_000);
    try expect_equal(gcd(90000000_000_000_000_000_000, 2), 2);
}
